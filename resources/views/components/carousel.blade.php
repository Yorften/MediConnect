<div id="carouselDarkVariant" {{ $attributes->merge(['class' => 'relative']) }} data-te-carousel-init
    ...
    <div class="relative w-full overflow-hidden after:clear-both after:block after:content-['']">
        ...
        <div class="relative float-left -mr-[100%] w-full !transform-none opacity-0 transition-opacity duration-[600ms] ease-in-out motion-reduce:transition-none"
            ...
            <img src="{{ asset('assets/images/Private-clinic.jpg') }}" class="block object-cover w-full h-[70vh]"
                alt="MediConnect 1" />
            <div class="absolute inset-x-[15%] bottom-5 hidden py-5 text-center text-black md:block">
                <h5 class="text-xl">Welcome to Our Clinic</h5>
                <p>
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla ut tortor auctor, ullamcorper dui
                    sed, gravida nisi. Integer non justo nec mauris faucibus posuere.
                </p>
            </div>
        </div>
        <!-- Second item -->
        <div class="relative float-left -mr-[100%] hidden w-full !transform-none opacity-0 transition-opacity duration-[600ms] ease-in-out motion-reduce:transition-none"
            ...
            <img src="{{ asset('assets/images/our-doctors.webp') }}" class="block object-cover w-full h-[70vh]"
                alt="MediConnect 2" />
            <div class="absolute inset-x-[15%] bottom-5 hidden py-5 text-center text-black md:block">
                <h5 class="text-xl">Meet Our Experienced Doctors</h5>
                <p>
                    Sed feugiat risus ac aliquet hendrerit. Proin sed nunc at turpis hendrerit aliquet. Fusce auctor
                    augue id turpis euismod, eu ultricies enim vestibulum.
                </p>
            </div>
        </div>
        <!-- Third item -->
        <div class="relative float-left -mr-[100%] hidden w-full !transform-none opacity-0 transition-opacity duration-[600ms] ease-in-out motion-reduce:transition-none"
            data-te-carousel-fade data-te-carousel-item>
            <img src="{{ asset('assets/images/medical-appointment.png') }}" class="block object-cover w-full h-[70vh]"
                alt="MediConnect 3" />
            <div class="absolute inset-x-[15%] bottom-5 hidden py-5 text-center text-black md:block">
                <h5 class="text-xl">Book Your Appointment Now</h5>
                <p>
