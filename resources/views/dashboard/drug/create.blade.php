    ...
    <div class="w-11/12 h-[90vh] mx-auto flex flex-col items-start justify-start">
        <div class="flex items-center flex-wrap">
            <ul class="flex items-center">
                ...
                <li class="inline-flex items-center">
                    <p class="text-gray-600 dark:text-gray-200 hover:text-blue-500">Add Drug</p>
                </li>
            </ul>
        </div>
        ...
        <div class="shadow-lg rounded-md bg-gray-200 dark:bg-gray-800 w-2/3 mx-auto p-4 mt-8">
            <form method="post" action="{{ route('drug.store') }}" class="mt-6 space-y-6">
                ...
                <div>
                    <x-input-label for="name" class="text-lg font-medium text-left text-gray-800 dark:text-gray-200"
                        :value="__('Name')" />
                ...
                <div class="flex items-center gap-4">
                    <x-primary-button
                        class="w-full text-center">{{ __('Add') }}</x-primary-button>
                </div>
