    ...
    <div class="w-11/12 h-[90vh] mx-auto flex flex-col items-start justify-start">
        <div class="flex items-center flex-wrap">
            <ul class="flex items-center">
                ...
                <li class="inline-flex items-center">
                    <p class="text-gray-600 dark:text-gray-200 hover:text-blue-500">Edit Speciality</p>
                </li>
            </ul>
        </div>
        <p class="text-none text-xl font-semibold indent-4 text-gray-800 dark:text-gray-200 mt-4">Edit speciality</p>
            ...
            <form method="post" action="{{ route('speciality.update', $speciality->id) }}" class="mt-6 space-y-6">
                ...
                <div>
                    ...
                    <x-text-input id="name" name="name" type="text" class="mt-1 block w-full"
                        :value="old('name', $speciality->name)" autofocus autocomplete="name" />
